...
--
-- Host: localhost:3307
-- Generation Time: Nov 13, 2021 at 03:37 PM
...
(10002, 'the new book', 'Mohan', 'CS', 'system parts', 'false', 2006, 'CS-sp-89'),
(10003, 'Quich Start', 'The Ram', 'EC', 'sircuit board', 'false', 1998, 'EC-sd-1001'),
...
INSERT INTO `librarys` (`id`, `password`, `name`, `last`, `email`) VALUES
(10000, 'sambare', 'bhupendra', 'sambare', 'bhupendrasam1404@gmail.com');
...
--
ALTER TABLE `issue`
  MODIFY `i_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10019;
...
--
ALTER TABLE `students`
  MODIFY `s_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100029;
COMMIT;
